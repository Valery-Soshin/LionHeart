...
namespace LionHeart.DataAccess.Migrations
{
    ...
    [Migration("20240204185659_AddGeneratedIdForBasket")]
    partial class AddGeneratedIdForBasket
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LionHeart.Core.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d4d6034a-3e53-48b8-92a5-2f0dc819de74",
                            Name = "Одежда"
                        });
                });
            ...
            modelBuilder.Entity("LionHeart.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f3f57380-12a0-40cd-a9ae-dd9828d7a8be",
                            CategoryId = "d4d6034a-3e53-48b8-92a5-2f0dc819de74",
