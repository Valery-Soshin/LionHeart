...
namespace LionHeart.DataAccess.Migrations
{
    ...
    [Migration("20240206154757_AlterTableProductUnits")]
    partial class AlterTableProductUnits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LionHeart.Core.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "324fb13d-d13b-4c32-9ef4-1495a0f1acb2",
                            Name = "Одежда"
                        });
                });
            ...
            modelBuilder.Entity("LionHeart.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7e966665-7d17-4886-9f9e-909c5936b5eb",
                            CategoryId = "324fb13d-d13b-4c32-9ef4-1495a0f1acb2",
                            Description = "Красивая и удобная футболка",
                            Name = "Футболка",
                            Price = 1250m,
                            Quantity = 1,
                            Specifications = "Размер - XXL",
                            UserId = "b198a07a-19e1-4629-9ef0-c52d3c093d17"
                        });
                });
            ...
            modelBuilder.Entity("LionHeart.Core.Models.ProductUnit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "089cb3c5-4dc7-4f37-bacd-c789f1831faa",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 2, 6, 18, 47, 56, 673, DateTimeKind.Unspecified).AddTicks(2636), new TimeSpan(0, 3, 0, 0, 0)),
                            ProductId = "7e966665-7d17-4886-9f9e-909c5936b5eb",
                            SaleStatus = 0
                        },
                        new
                        {
                            Id = "6ba575c3-2b36-4625-904e-b59aa932662e",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 2, 6, 18, 47, 56, 673, DateTimeKind.Unspecified).AddTicks(2697), new TimeSpan(0, 3, 0, 0, 0)),
                            ProductId = "7e966665-7d17-4886-9f9e-909c5936b5eb",
                            SaleStatus = 0
                        },
                        new
                        {
                            Id = "baf5f4df-2a71-4d06-bb40-33df653567cc",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 2, 6, 18, 47, 56, 673, DateTimeKind.Unspecified).AddTicks(2714), new TimeSpan(0, 3, 0, 0, 0)),
                            ProductId = "7e966665-7d17-4886-9f9e-909c5936b5eb",
                            SaleStatus = 0
                        },
                        new
                        {
                            Id = "66aaaaf3-020f-48de-867a-8f6732b01351",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 2, 6, 18, 47, 56, 673, DateTimeKind.Unspecified).AddTicks(2734), new TimeSpan(0, 3, 0, 0, 0)),
                            ProductId = "7e966665-7d17-4886-9f9e-909c5936b5eb",
                            SaleStatus = 0
                        },
                        new
                        {
                            Id = "873c0ea6-75af-4c6c-86ba-7d1ca2cd16ed",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 2, 6, 18, 47, 56, 673, DateTimeKind.Unspecified).AddTicks(2752), new TimeSpan(0, 3, 0, 0, 0)),
                            ProductId = "7e966665-7d17-4886-9f9e-909c5936b5eb",
                            SaleStatus = 0
                        });
                });
            ...
            modelBuilder.Entity("LionHeart.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b198a07a-19e1-4629-9ef0-c52d3c093d17",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7cec0bb5-3807-4b63-877e-535513115ec3",
                            Email = "admin",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PersonalDiscount = 0m,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e59a019b-4b0f-4065-b452-d22c0f658668",
