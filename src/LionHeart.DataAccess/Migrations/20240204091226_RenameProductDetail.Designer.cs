...
namespace LionHeart.DataAccess.Migrations
{
    ...
    [Migration("20240204091226_RenameProductDetail")]
    partial class RenameProductDetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LionHeart.Core.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5407c651-969e-4de8-8b6e-16ccd1db9445",
                            Name = "Одежда"
                        });
                });
            ...
            modelBuilder.Entity("LionHeart.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "752b8e4d-63e2-44e8-b71f-9bb2c3deb0d1",
                            CategoryId = "5407c651-969e-4de8-8b6e-16ccd1db9445",
            ...
            modelBuilder.Entity("LionHeart.Core.Models.MarkedProduct", b =>
                {
                    ...
                    b.HasOne("LionHeart.Core.Models.User", null)
                        ...
                        .HasConstraintName("fk_marked_products_users_user_id");
